...
# Para ver replay, primero se debe detener publisher, y los demas contenedores deben de estar corriendo, aqui hay varias formas:
./replay.sh
...
docker compose exec audit python replay.py, tambien requiere del sistema corriendo, hace lo mismo que replay.sh

docker compose exec audit python replay.py --offset 50, este es un ejemplo para el caso en el que se quiera ejecutar desde un offset especifico

docker compose exec audit python replay.py --timestamp "2026-01-30T16:00:00", este es un ejemplo en el caso en que se quiera ejecutar desde un tiempo en especifico
